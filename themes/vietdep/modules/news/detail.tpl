    ...
    <div id="idcomment">
        ...
        <div id="formcomment" class="comment-form">
            ...
            <div class="box-border content-box">
                <div class="box clearfix">
                    <input id="commentname" type="text" value="{NAME}" {DISABLED} class="text input-c fl" onblur="if(this.value=='')this.value='{LANG.comment_name}';" onclick="if(this.value=='{LANG.comment_name}')this.value='';"/>
                    <input id="commentemail_iavim" type="text" value="{EMAIL}" {DISABLED} class="text input-c fr" onblur="if(this.value=='')this.value='{LANG.comment_email}';" onclick="if(this.value=='{LANG.comment_email}')this.value='';"/>
                </div>
                <p>
